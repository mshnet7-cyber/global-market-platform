...
ok("demo shop is wired to merchant context", text("lib/merchant-access.ts").includes('if (demo)') && text("lib/merchant-access.ts").includes('demo.role !== "shop_owner"') && text("lib/merchant-access.ts").includes('global-market-demo-shop'));\nconst stage2Route=text("app/api/stage2/route.ts");\nconst demoTx=text("supabase/migrations/20260920011837_gmp_preview_demo_transaction_wrappers_20260920.sql");\nok("demo Stage 2 transactions use guarded wrappers", stage2Route.includes('isShopDemo ? "gmp_demo_create_inventory_product"') && stage2Route.includes('isShopDemo ? "gmp_demo_create_and_post_sale"') && stage2Route.includes('isShopDemo ? "gmp_demo_create_purchase"') && stage2Route.includes('isShopDemo ? "gmp_demo_create_and_post_expense"') && stage2Route.includes('isShopDemo ? "gmp_demo_create_manual_journal"') && demoTx.includes("gmp_preview_demo_guard"));\nconst stage3Access=text("supabase/migrations/20260920011941_gmp_preview_demo_stage3_access_20260920.sql");\nok("demo Stage 3 access migration is tracked", stage3Access.includes("gmp_demo_preview_shop_invoice_profile_all") && stage3Access.includes("gmp_demo_preview_shop_cameras_all") && stage3Access.includes("gmp_demo_preview_shop_compliance_cases_all"));
