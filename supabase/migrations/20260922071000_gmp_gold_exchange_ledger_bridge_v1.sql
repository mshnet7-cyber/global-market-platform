...
begin
 ...
 when 'purchase' then 'in' when 'repair_in' then 'in' when 'adjustment_in' then 'in' when 'transfer_in' then 'in' when 'return_in' then 'in' when 'opening_balance' then 'in' when 'person_gold_purchase' then 'in' when 'exchange_in' then 'in'
 when 'sale' then 'out' when 'repair_out' then 'out' when 'adjustment_out' then 'out' when 'transfer_out' then 'out' when 'return_out' then 'out' when 'exchange_out' then 'out' else null end;
 ...
 case new.movement_type when 'purchase' then 'purchase' when 'sale' then 'sale' when 'repair_in' then 'repair_in' when 'repair_out' then 'repair_out' when 'transfer_in' then 'transfer_in' when 'transfer_out' then 'transfer_out' when 'person_gold_purchase' then 'buyback' when 'exchange_in' then 'exchange_in' when 'exchange_out' then 'exchange_out' when 'return_in' then 'sale_return' when 'return_out' then 'purchase_return' when 'adjustment_in' then 'adjustment' when 'adjustment_out' then 'adjustment' when 'opening_balance' then 'adjustment' end,
