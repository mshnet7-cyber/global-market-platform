-- Financial/inventory concurrency hardening, production-applied 2026-09-23.
CREATE OR REPLACE FUNCTION public.gmp_adjust_inventory(p_organization_id uuid, p_product_id uuid, p_quantity_delta numeric, p_weight_delta numeric, p_unit_cost numeric, p_movement_type text)
 RETURNS jsonb
 LANGUAGE plpgsql
 SET search_path TO ''
AS $function$
...
begin
  ...
  return jsonb_build_object(
    ...
    'current_quantity',v_q+p_quantity_delta,
    'current_weight_grams',v_w+p_weight_delta
  );
end;
$function$;
