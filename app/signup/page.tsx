...
export default async function SignupPage({ searchParams }: { searchParams: Promise<{ next?: string; plan?: string; error?: string }> }) {
  ...
  return <div className="page-frame login-page signup-page">
    ...
    <main className="container login-layout signup-layout">
      <section className="login-story">
        <div className="eyebrow"><span className="live-dot" />MERCHANT WORKSPACE</div>
        ...
        <div className="login-highlights">
          <div className="login-highlight"><strong>START</strong><span>حساب وتسجيل آمن</span></div>
          <div className="login-highlight"><strong>STORE</strong><span>المؤسسة والمتجر</span></div>
          <div className="login-highlight"><strong>WORKSPACE</strong><span>مساحة تشغيل موحدة</span></div>
        </div>
      </section>
