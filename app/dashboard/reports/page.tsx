  ...
  return <div className="dashboard-shell">
    ...
    <main className="container dashboard-main reports-page">
      <section className="dashboard-hero">
        <div><div className="eyebrow">التقارير والتشغيل</div><h1 className="dashboard-title">التقارير</h1><p className="dashboard-subtitle">مركز واحد للوصول إلى تقارير التشغيل والمال والمخزون.</p></div>
      ...
      <section className="card report-note"><div className="eyebrow">ملاحظة</div><h2>مركز التقارير الحالي</h2><p className="hero-copy">يعرض هذا القسم التقارير المتاحة داخل وحدات المنصة ويجمعها في نقطة وصول واحدة. لا يتم تقديم أي تقرير حكومي أو إرسال ضريبي من هذه الصفحة.</p></section>
    </main>
  </div>;
}
