...
export default function DirectoryPage(){
  ...
  return <main className="stage2-public">
    <header className="stage2-public-head"><div><div className="eyebrow">GOLD STORES DIRECTORY</div><h1>دليل محلات الذهب</h1><p>ملفات تجارية مرتبطة بمنصة الذهب، مع موقع وخدمات وفروع وقنوات تواصل وحالة نشر.</p></div><div><Link href="/marketplace" className="btn btn-primary">فتح Marketplace</Link></div></header>
