      ...
      <section className="terminal-layout">
        ...
        <section className="terminal-content">
          ...
          <div className="terminal-grid-two">
            ...
            <section className="terminal-card"><div className="terminal-card-head"><div><span className="micro-label">COMPARISON</span><strong>مقارنة سريعة</strong></div></div><div className="compare-grid"><div><span>Spot</span><b>{fmt(currentValue, selectedCurrency)}</b></div><div><span>High</span><b>{fmt(high, selectedCurrency)}</b></div><div><span>Low</span><b>{fmt(low, selectedCurrency)}</b></div><div><span>Change</span><b>{pct(derivedPercent)}</b></div></div></section>
          </div>
