const dictionaries: Record<string, Record<string, string>> = {
  ar: {
    gold: "الذهب", silver: "الفضة", markets: "الأسواق", stocks: "الأسهم", news: "الأخبار", demo: "معاينة شاشة الأسعار", login: "تسجيل الدخول", signup: "إنشاء الحساب", country: "الدولة", language: "اللغة", apply: "تطبيق", createDisplay: "أنشئ شاشة", goldView: "شاهد الذهب", displayDemo: "جرّب شاشة المحل",
    ...
    referenceFooter: "معلومات مرجعية فقط. ليست وساطة أو استشارة استثمارية.", spot: "فوري", bid: "شراء مرجعي", ask: "بيع مرجعي", gram: "غرام", marketDataNote: "بيانات الأسواق المعروضة هي بيانات سوق مرجعية متأخرة/نهاية اليوم وفق ترخيص المصدر.",
  ...
  en: {
    gold: "Gold", silver: "Silver", markets: "Markets", stocks: "Stocks", news: "News", demo: "Display Preview", login: "Login", signup: "Create account", country: "Country", language: "Language", apply: "Apply", createDisplay: "Create Display",
    ...
    referenceFooter: "Reference information only. Not brokerage or investment advice.", spot: "Spot", bid: "Bid", ask: "Ask", gram: "gram", marketDataNote: "Displayed market data is delayed/end-of-day reference data subject to the source license.", statusLive: "LIVE", statusDelayed: "DELAYED", statusStale: "STALE", statusUnavailable: "UNAVAILABLE",
  ...
  tr: {
    gold: "Altın", silver: "Gümüş", markets: "Piyasalar", stocks: "Hisseler", news: "Haberler", demo: "Ekran Önizleme", login: "Giriş", signup: "Hesap oluştur", country: "Ülke", language: "Dil", apply: "Uygula", createDisplay: "Ekran Oluştur",
    ...
    referenceFooter: "Yalnızca referans bilgileri. Aracılık veya yatırım tavsiyesi değildir.", spot: "Spot", bid: "Alış", ask: "Satış", gram: "gram", marketDataNote: "Gösterilen piyasa verileri, sağlayıcı lisansına tabi gecikmeli/gün sonu referans verileridir.", statusLive: "CANLI", statusDelayed: "GECİKMELİ", statusStale: "ESKİ", statusUnavailable: "KULLANILAMIYOR",
  ...
  de: {
    gold: "Gold", silver: "Silber", markets: "Märkte", stocks: "Aktien", news: "Nachrichten", demo: "Display-Vorschau", login: "Anmelden", signup: "Konto erstellen", country: "Land", language: "Sprache", apply: "Anwenden", createDisplay: "Display erstellen",
    ...
    referenceFooter: "Nur Referenzinformationen. Keine Anlageberatung oder Vermittlung.", spot: "Spot", bid: "Geldkurs", ask: "Briefkurs", gram: "Gramm", marketDataNote: "Angezeigte Marktdaten sind verzögerte/Tagesenddaten nach Lizenz des Datenanbieters.", statusLive: "LIVE", statusDelayed: "VERZÖGERT", statusStale: "VERALTET", statusUnavailable: "NICHT VERFÜGBAR",
